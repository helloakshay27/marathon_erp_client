$(document).ready(function(){
    ...
    $('.pro-radio-tabs2 .pro-radio-tabs__tab').click(function(){
        $('.pro-radio-tabs2 .pro-radio-tabs__tab').removeClass('pro-radio-tabs__tab__selected');
    ...
    $('.pro-radio-tabs1 .pro-radio-tabs__tab').click(function(){
        $('.pro-radio-tabs1 .pro-radio-tabs__tab').removeClass('pro-radio-tabs__tab__selected');
    ...
    $('.pro-radio-tabs3 .pro-radio-tabs__tab').click(function(){
        $('.pro-radio-tabs3 .pro-radio-tabs__tab').removeClass('pro-radio-tabs__tab__selected');
